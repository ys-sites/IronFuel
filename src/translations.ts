export const translations = {
  en: {
    ...
    faq: {
      ...
      description: "Everything you need to know about our products and how to use them for maximum efficacy."
    },
    trust: {
  ...
  fr: {
    ...
    faq: {
      ...
      description: "Tout ce que vous devez savoir sur nos produits et comment les utiliser pour une efficacité maximale."
    },
    trust: {
